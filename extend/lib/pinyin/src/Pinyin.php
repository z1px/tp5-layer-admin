...
class Pinyin
{
     ...
     * Dict loader.
     *
     * @var \lib\pinyin\src\DictLoaderInterface
     */
    protected $loader;
    ...
    {
        $this->loader = $loaderName ?: 'lib\\pinyin\\src\\FileDictLoader';
    }
     ...
     * Loader setter.
     *
     * @param \lib\pinyin\src\DictLoaderInterface $loader
     *
     * @return $this
     */
     ...
     * Return dict loader,.
     *
     * @return \lib\pinyin\src\DictLoaderInterface
     */
     ...
     *
     * @param string                               $string
     * @param \lib\pinyin\src\DictLoaderInterface $dictLoader
     *
     * @return string
     */
